...
#SBATCH --job-name=qctriDNA.sh
#SBATCH --mail-type=END
#SBATCH --mail-user=sleon.1@alumni.unav.es
#SBATCH --time=23:59:00
#SBATCH --output=qual_trimmedDNA.log
#SBATCH --mem=100G
#SBATCH -p short
...
do	
	...
	fastqc -o /home/sleon.1/Proj01/TFM/Raw_data/DNA/DNA_FASTQC_analysis/trimmed /home/sleon.1/Proj01/TFM/Raw_data/DNA/trimmedDNA_L3RR/paired/$file
